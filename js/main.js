jQuery(function ($) {
    ...
    $(".p_name_1").on("click", function () {
        ...
        $(".box_2, .box_3, .box_4, .box_5, .box_6, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_2").on("click", function () {
        $(".fade, .box_2").addClass("block").removeClass("none");
        $(".box_1, .box_3, .box_4, .box_5, .box_6, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_3").on("click", function () {
        $(".fade, .box_3").addClass("block").removeClass("none");
        $(".box_1, .box_2, .box_4, .box_5, .box_6, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_4").on("click", function () {
        $(".fade, .box_4").addClass("block").removeClass("none");
        $(".box_1, .box_3, .box_2, .box_5, .box_6, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_5").on("click", function () {
        $(".fade, .box_5").addClass("block").removeClass("none");
        $(".box_1, .box_3, .box_4, .box_2, .box_6, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_6").on("click", function () {
        $(".fade, .box_6").addClass("block").removeClass("none");
        $(".box_1, .box_2, .box_4, .box_5, .box_3, .box_7, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_7").on("click", function () {
        $(".fade, .box_7").addClass("block").removeClass("none");
        $(".box_1, .box_3, .box_2, .box_5, .box_6, .box_4, .box_8").removeClass("block").addClass("none");
    });
    $(".p_name_8").on("click", function () {
        $(".fade, .box_8").addClass("block").removeClass("none");
        $(".box_1, .box_3, .box_4, .box_2, .box_6, .box_5, .box_7").removeClass("block").addClass("none");
    });
});
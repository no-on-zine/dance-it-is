 ...
 */
function jcdn_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter jcdn default saturation level.
	 *
	 * @since jcdn 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'jcdn_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.jcdn-front-page) .entry-title,
...
.colors-custom .jcdn-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.jcdn-front-page .panel-content .recent-posts article,
...
.colors-custom.jcdn-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters jcdn custom colors CSS.
	 *
	 * @since jcdn 1.0
	 *
	 ...
	 */
	return apply_filters( 'jcdn_custom_colors_css', $css, $hue, $saturation );
}

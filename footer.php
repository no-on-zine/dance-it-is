<section id="f_menu">
    <div class="c_wrap">
        ...
        <div class="menu_w">
            ...
            <ul>
                <li>
                    <a href="#">Sapporo Choreo振付家養成講座</a>
                </li>
                <li>
                    <a href="#">レジデンスアーティスト育成事業2021</a>
                </li>
                <li>
                    <a href="#">Dance Camp クリエイション＆ダイアローグ・ワークショップ</a>
                </li>
                <li>
                    <a href="#">DANCE ARTIST VIEW2020「セルフカルチベート企画」</a>
                </li>
                <li>
                    <a href="#">ダンスアートプロジェクト！！</a>
                </li>
                <li>
                    <a href="#">建築とコンタクト（京都‒札幌）</a>
                </li>
                <li>
                    <a href="#">わたしと身体の緩やかなダンス革命 in 福岡</a>
                </li>
                <li>
                    <a href="#">「役立つ」バレエ・ダンス史</a>
                </li>
                <li>
                    <a href="#">第4回「ダンスを撮る！」ダンス映像撮影ワークショップ</a>
                </li>
                <li>
                    <a href="#">KYOTO Dance Platform（仮）</a>
                </li>
            </ul>
            <ul>
                <li>
